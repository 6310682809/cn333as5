...
private fun LightDarkThemeItem() {
    Row(
        ...
        Switch(
            checked = MyContactsThemeSettings.isDarkThemeEnabled,
            onCheckedChange = { MyContactsThemeSettings.isDarkThemeEnabled = it },
            modifier = Modifier
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            onClick = {
                MyContactsRouter.navigateTo(Screen.Trash)
                closeDrawerAction()
            }
        )
        LightDarkThemeItem()
